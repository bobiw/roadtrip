...
# GOOGLE_MAPS_API_KEY = "AIzaSyAm109KdBNIVZluRG8RE8hUcn3yl9bFirA" # browser
GOOGLE_MAPS_API_KEY = "AIzaSyAm109KdBNIVZluRG8RE8hUcn3yl9bFirA"
...
thisRunPopulation_size = 130

all_waypoints = ["Katz's Delicatessen, New York, NY",
                 ...
                 "Redwood National and State Parks, Orick, CA",
...
def CreateOptimalRouteHtmlFile(optimal_route, distance, display=True):
    ...
    <html lang="en">
      <head>
        ...
        <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAm109KdBNIVZluRG8RE8hUcn3yl9bFirA&callback=initMap" ></script>
        <script>
            var routes_list = []
